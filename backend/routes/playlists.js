...
const coversPath = path.join(uploadsPath, "playlist-covers");
const videosPath = path.join(uploadsPath, "playlist-videos");
    ...
    (req, res) => {
        ...
        try {
            ...
            const newPlaylist = {
                ...
                cover:
                    `/uploads/playlist-covers/${coverFile.filename}`,

                video:
                    `/uploads/playlist-videos/${videoFile.filename}`,
